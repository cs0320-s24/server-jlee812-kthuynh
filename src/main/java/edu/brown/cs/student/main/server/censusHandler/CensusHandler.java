...
public class CensusHandler implements Route {
   ...
   *
   * @param cacheControl The cache controller for the handler.
   */
  public CensusHandler(CacheControl<Location, Map<String, Object>> cacheControl) {
    this.cacher = cacheControl;
  }
